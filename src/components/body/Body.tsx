      ...
      <div className="lowerBody">
        <div className="articles">
          <div className="container">
            <div>
              <img src={require('../../assets/images/Mask group (6).png')} className='captionImage' alt="image6" />
            </div>
          ...
          <div className="container">
            <div className="captionImage">
              <img src={require('../../assets/images/Mask group (7).png')} className='captionImage' alt="image7" />
            </div>
            <div className="captionBody">
          ...
          <div className="container">
            <div className="captionImage">
              <img src={require('../../assets/images/Mask group (8).png')} className='captionImage' alt="image8" />
            </div>
            <div className="captionBody">
        ...
        <div className="ad">
          <img src={require('../../assets/images/Mask group (9).png')} className='adImage' alt='Ad-image' />
          <img src={require('../../assets/logos/Dispatch hub logo 1.png')} className='adLogo' alt='Ad-logo' />
